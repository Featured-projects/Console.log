...
const About = () => {
    return (
        <div className='container utility_height'>
            <h1>About</h1>
            <p className='description-para'>The CONSOLE.LOG app allows you to post, edit, save, and delete your blog posts. You can compose posts from anywhere, anytime with the app. You can save your post and edit it on a computer.</p>
